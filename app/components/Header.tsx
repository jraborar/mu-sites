import { Terminal, Rocket, ScanEye, LayoutGrid, type LucideIcon } from 'lucide-react'
...
// context-aware app switcher on the right. Identical across the apps; only
// `current` differs. Per-app brand mark: >_ Staging, Rocket Deployment,
// ScanEye VRT, LayoutGrid Sites.
...
const BRAND: Record<AppKey, { icon: LucideIcon; name: string; subtitle: string }> = {
  ...
  sites:      { icon: LayoutGrid, name: 'MU Sites',      subtitle: 'Per-site staging & deployment timeline' },
}
